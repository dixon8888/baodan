    ...
    <thead>
      <tr>
        ...
        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
           ...
           <!--     <td><button style="background:red" onclick="window.open('http://zrrrt.com/baodan/index.php/Home/Form/edit2/id/<?php echo ($vo["id"]); ?>')">编辑</button> </td> -->
                <td><button style="background:red" onclick="window.open('<?php echo U('Home/Form/edit2',array('id'=>encode($vo['id'])));?>')">编辑</button> </td>
